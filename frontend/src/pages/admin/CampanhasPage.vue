<template>
  <q-page class="q-pa-lg">
    <div class="q-mb-lg">
      ...
      <p style="color: var(--od-text-3); margin: 4px 0 0; font-size: 14px;">Campanhas de marketing e cupons</p>
    </div>
    <q-card flat bordered class="od-card">
      <q-card-section class="text-center q-py-xl">
        <q-icon name="campaign" size="48px" style="color: var(--od-text-5);" />
        <p style="margin-top: 12px; color: var(--od-text-3);">Campanhas — em construção</p>
      </q-card-section>
    </q-card>
  </q-page>
</template>
